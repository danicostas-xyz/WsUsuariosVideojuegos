...
public class GestorVideojuego {
	...
	public GestorVideojuego(String rutaArchivo) {
		super();
	 ...
	 *         nombre esta vacio o solo tiene espacios en blanco, o tiene menos de 3
	 *         letras <b>2</b> la compañia esta vacia o solo tiene espacios en
	 *         blanco, o tiene menos de 5 letras<b>3</b> la nota es inferior a 0 o
	 *         superior a 100 <b>4</b> el videojuego se ha registrado correctamente
	...
	public int guardar(Videojuego v) {
		...
		dvf = new DaoVideojuegoFichero(rutaArchivo);
		try {
	 ...
	 * guardado en la persistencia. Un videojuego esta validado cuando el nombre, la
	 * empresa y la nota guardada coincide con el videojuego pasado por parametro.
	 * 
	 * @param v videojuego a validar/comparar
	 * @return <b>0</b> el videojuego no existe, <b>1</b> el videojuego existe y es
	 *         valido, <b>2</b> el videojuego existe pero no es valido y <b>666</b>
	 ...
	 *         borrado correctamente <b>2</b> el videojuego existe pero no es valido
	 *         y <b>666</b> en caso de que haya algún problema en el de entrada
	 *         salida
	 */
	 ...
	 * @throws Exception si sucede algún problema de entrada/salida
	 */
	public ArrayList<Videojuego> mostrar() throws Exception {
		dvf = new DaoVideojuegoFichero(rutaArchivo);
